...
public class editbattles2 extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
     ...
     int status=dao.editbattles(b,request.getParameter("userid"));
     if(status>0)
         ...
         out.print("error");
            ...
            Logger.getLogger(editbattles2.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
